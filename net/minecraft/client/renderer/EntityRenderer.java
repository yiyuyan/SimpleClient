...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) throws Exception {
        this.frameInit();
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        else if (iblockstate.getMaterial() == Material.WATER)
        {
            ...
            Vec3d vec3d4 = CustomColors.getUnderwaterColor(this.mc.world, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0D, this.mc.getRenderViewEntity().posZ);

    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face)
    {
        ...
        else
        {
            ...
            else if (!this.isHittingBlock || !this.isHittingPosition(loc))
            {
                ...
                Hack fastBreak = Category.BLOCK.get("FastBreak");
                if(fastBreak!=null && fastBreak.enabled){
                    this.connection.sendPacket(new CPacketPlayerDigging(CPacketPlayerDigging.Action.STOP_DESTROY_BLOCK, loc, face));
                }

...
public class GuiMultiplayer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(1122,15,10,(hack!=null && hack.enabled)?"1.12":"1.12.2"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 1122){
                if(hack!=null){
                    if(hack.enabled){
                        hack.setEnabled(false);
                        button.displayString = "1.12.2";
                    }
                    else{
                        hack.setEnabled(true);
                        button.displayString = "1.12";
                    }
                }
            }
        }

...
public class BlockStateContainer
{
    ...
    static class StateImplementation extends BlockStateBase
    {
        ...
        {
            boolean ret = this.block.shouldSideBeRendered(this, blockAccess, pos, facing);
            Hack xray = Category.RENDER.get("XRay");
            if(xray!=null && xray.enabled){
                if(!Arrays.asList(XRay.blocks).contains(this.block)){
                    ret = false;
                }else{
                    ret = true;
                }
